...
file_path1 = str(Path(Path(__file__).parent, 'data', 'nanonis_long_term', '20190510_LC_05_B001.dat'))
file_path2 = str(Path(Path(__file__).parent, 'data', 'nanonis_long_term', '20190510_LC_05_A001.dat'))
file_path3 = str(Path(Path(__file__).parent, 'data', 'nanonis_long_term', '20190510_LC_05_Longterm001.dat'))
